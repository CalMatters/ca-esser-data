...
A version of this dataset powers the district lookup tool in this story: “[Use it or lose it: California schools race to spend the last of their pandemic funds](https://calmatters.org/education/k-12-education/2024/09/pandemic-relief/)” by Carolyn Jones (published September 30, 2024).  

This repo was last updated May 29, 2025.

## Data sources

The original files can be found in `/sources`. The original source links provide detail on how the funding could be used.
...
| ESSER III     | September 30, 2024  | https://www.cde.ca.gov/fg/cr/arpact.asp   | `arpesseriii3213.xlsx` `arpesseriii3214.xlsx` |
...
3. For each LEA, take the most recent `TotalAllocatedAmount`.
4. For ESSER III, sum the above for the 3213 and 3214 spreadsheets to get total allocated and spent.


## Data dictionary

These are the columns in `ca_esser.csv`. Each row is a local education agency, either a district or charter school that is not within a district. Values in all expenditure and allocation columns are `NA` if there was not a value for that funding round.
...
| iii_all       | Final ESSER III allocation the LEA is eligible to receive as of the September 2024 reporting period                                                                                                                                                           |
| total_exp     | Total amount of ESSER funding the LEA reported expending over all reporting periods                                                                                                                                                                           |
| total_all     | Final ESSER allocation the LEA is eligible to receive as of the September 2024 reporting period                                                                                                                                                               |
